settings_list = SettingsList(schema_id='org.gtk.example')

settings_list.add_setting("never-applied", "bool", 'true')

appearance_section = settings_list.add_section("Appearance")
...
fonts_section = settings_list.add_section("Fonts")
...
top_bar_section = settings_list.add_section("Top Bar")
...
sound_section = settings_list.add_section("Sound")
...
touchpad_section = settings_list.add_section("Touchpad")
...
night_light_section = settings_list.add_section("Night Light")
